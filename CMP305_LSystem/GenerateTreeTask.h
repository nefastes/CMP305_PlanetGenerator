...
{
public:
	GenerateTreeTask(ID3D11Device* device, ID3D11DeviceContext* deviceContext, HWND hwnd, const unsigned& tree_system_iterations,
...
private:
	...
	HWND window_;
	unsigned tree_system_iterations_;
